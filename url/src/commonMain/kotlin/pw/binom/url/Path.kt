...
value class Path internal constructor(val raw: String) {
    ...
    fun getVariables(
        mask: String,
        dest: MutableMap<String, String> = HashMap(),
...
//    }
    ...
    fun startsWith(other: Path) = startsWith(other.raw)
    fun startsWith(path: String) = raw.startsWith(path)
    fun removePrefix(other: Path) = raw.removePrefix(other.raw).toPath
}
