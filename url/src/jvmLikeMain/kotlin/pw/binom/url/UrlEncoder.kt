...
actual object UrlEncoder {
    actual fun encode(input: String): String = java.net.URLEncoder.encode(input, Charsets.UTF_8).replace("+", "%20")

    actual fun decode(input: String): String = java.net.URLDecoder.decode(input, Charsets.UTF_8)
